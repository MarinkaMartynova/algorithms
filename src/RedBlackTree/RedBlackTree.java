...
public class RedBlackTree<T extends Comparable<T>> {  //Бинарное дерево - список, у каждой ноды которого 2 значения.
    Node root;
    ...
    private Node rebalanced(Node node) {    //балансировщик это 3 метода снизу записаны
        Node result = node;
